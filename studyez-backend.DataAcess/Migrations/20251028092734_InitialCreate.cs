        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Users_Role", "[Role] IN ('Free','Pro','Premium')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SimplifiedContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ExamResults_Answers", "[CorrectAnswers] >= 0 AND [CorrectAnswers] <= [TotalQuestions]");
                    table.CheckConstraint("CK_ExamResults_OverallScore", "[OverallScore] >= 0 AND [OverallScore] <= 100");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Questions_Type", "[Type] IN ('multiple-choice','true-false','short-answer')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModuleScores", x => x.Id);
                    table.CheckConstraint("CK_ModuleScores_Answers", "[CorrectCount] >= 0 AND [CorrectCount] <= [QuestionsCount]");
                    table.CheckConstraint("CK_ModuleScores_Score", "[Score] >= 0 AND [Score] <= 100");
                    table.ForeignKey(
                        name: "FK_ModuleScores_ExamResults_ExamResultId",
                        column: x => x.ExamResultId,
                        principalTable: "ExamResults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModuleScores_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ExamQuestions_Points", "[Points] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Points = table.Column<decimal>(type: "decimal(5,2)", nullable: false, defaultValue: 0m),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamResultAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamResultAnswers_ExamResults_ExamResultId",
                        column: x => x.ExamResultId,
                        principalTable: "ExamResults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamResultAnswers_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamResultAnswers_ExamResultId",
                table: "ExamResultAnswers",
                column: "ExamResultId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamResultAnswers_QuestionId",
                table: "ExamResultAnswers",
                column: "QuestionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamResults_UserId_ExamId",
                table: "ExamResults",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModuleScores_ExamResultId",
                table: "ModuleScores",
                column: "ExamResultId");

            migrationBuilder.CreateIndex(
                name: "IX_ModuleScores_ExamResultId_ModuleId",
                table: "ModuleScores",
                columns: new[] { "ExamResultId", "ModuleId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ModuleScores_ModuleId",
                table: "ModuleScores",
                column: "ModuleId");
